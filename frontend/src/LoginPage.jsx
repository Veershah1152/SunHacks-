      ...
      >
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ 
            ...
            Strategic Intelligence Sentinel v1.0
          </p>
        </div>
        ...
        <div style={{ marginBottom: '32px' }}>
          <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.6)', lineHeight: 1.6, marginBottom: '24px' }}>
            Enter your credentials to access the encrypted global intelligence network.
          </p>
          ...
          <form onSubmit={handleCredentialSubmit} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <button type="submit" style={buttonStyle}>
              {isRegistering ? 'Register Access' : 'Initialize Command'}
            </button>
          </form>
          ...
          <div style={{ marginTop: '24px', fontSize: '0.8rem', color: 'var(--primary)', cursor: 'pointer' }}
            ...
            {isRegistering ? 'Already cleared for access? Log in.' : 'Request new agent clearance (Register)'}
          </div>
        </div>


        <div style={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.2)', letterSpacing: '0.05em' }}>
          SECURE ENCRYPTED CHANNEL // END-TO-END VERIFICATION
        </div>
      </motion.div>
